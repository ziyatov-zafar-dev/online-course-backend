package uz.codebyz.onlinecoursebackend.teacher.dto.promoCode;
...
@Component
public class TeacherPromoCodeMapper {
    public TeacherCourseAndPromoCodeResponseDto toDto(PromoCode promoCode, UserDeviceService deviceService) {
        TeacherCourseAndPromoCodeResponseDto response = new TeacherCourseAndPromoCodeResponseDto();
